...
3. Inside the extracted folder is a folder entitled 'CMP3749 CMP9770 Big Data' which contains the .devcontainer folder. Move 'CMP3749 CMP9770 Big Data' to wherever you like, this will be your working directory for this module.
4. Make sure Docker Desktop is running. You can minimise the window.
5. Open VS Code, go to File -> Open Folder, and select your 'CMP3749 CMP9770 Big Data' folder.
